...
def numero
    i = 0
    $journalists.each do |human|
        if human=~ /\d/ 
        i += 1
        end
    end
    puts "Il y a #{i} handles qui contiennent des numéros"
end
...
def lettre
    ...
    puts "il y a #{i} handles qui contiennent 'aude'"
end
...
def majuscule
    ...
    puts "il y a #{i} handles qui commence par une majuscule"
end
...
def maju 
    ...
    puts "il y a #{i} handles qui contiennent une majuscule"
end
...
def unders
    ...
    puts "il y a #{i} handles qui contiennent un underscore"
end

def alpha
    puts "Liste par ordre aphabétique : #{$journalists.sort} "
end

def court   
    puts "Liste des 50 handles les plus court :"  
    puts $journalists.sort_by{|human| human.length}.take(50)
end
